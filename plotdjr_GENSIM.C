...
void makeplot(const char *name, TTree *tree, TCut weight, const char *drawstring, const char *xlabel, int nbins, double xlow, double xhigh, int typeMC) {
  ...
  cout << "all typeMC=" << typeMC << endl;
  if (typeMC == 0) {
  //this is for NLO with FXFX merging

    // test gkole
    cout << "test: typeMC=" << typeMC << endl;
...
void plotdjr(const TString & infile, const TString & outfile) {
  ...
  //tree->SetAlias("GenEvent","GenEventInfoProduct_generator__GEN.obj"); // commened out 9th May
  tree->SetAlias("GenEvent","GenEventInfoProduct_generator__SIM.obj"); // new 9th May


  //tree->SetAlias("LHEEvent","LHEEventProduct_externalLHEProducer__LHE.obj"); // commented out 9th May
  tree->SetAlias("LHEEvent","LHEEventProduct_externalLHEProducer__SIM.obj"); // new 9th May
  ...
  //  int typeMC = 2;
  int typeMC = 0; // for  NLO with FXFX merging (gkole)
